    ...
    Scaffold(
        topBar = {
            CenterAlignedTopAppBar(title = {
                Text(text = "Cadastrar Usuário", color = Color.White, fontWeight = FontWeight.Bold)
            },
        ...
        ContentCadastrarUsuarioView(it,navController,viewModel)
    }
}


@Composable
fun ContentCadastrarUsuarioView(it: PaddingValues,navController: NavController,viewModel: UsuariosViewModel){
